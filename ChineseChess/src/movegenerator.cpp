...
QString MoveGenerator::digitToChinese(const QChar &digit, bool black)
{
    ...
    if (black)
    {
        ...
        case '9':
            ...
            break;
        case 'a':
            strDigit = QStringLiteral("前");
            break;
        case 'b':
            strDigit = QStringLiteral("后");
            break;
        case 'c':
            strDigit = QStringLiteral("一");
            break;
        case 'd':
            strDigit = QStringLiteral("二");
            break;
        case 'e':
            strDigit = QStringLiteral("三");
            break;
        case 'f':
            strDigit = QStringLiteral("四");
            break;
        case 'g':
            strDigit = QStringLiteral("五");
            break;
        case 'q':
            strDigit = QStringLiteral("前");
            break;
        case 'z':
            strDigit = QStringLiteral("中");
            break;
        case 'h':
            strDigit = QStringLiteral("后");
            break;
    ...
    else
    {
        ...
        case '5':
            ...
            break;
        case '6':
            strDigit = QStringLiteral("六");
            break;
        case '7':
            strDigit = QStringLiteral("七");
            break;
        case '8':
            strDigit = QStringLiteral("八");
            break;
        case '9':
            strDigit = QStringLiteral("九");
            break;
        case 'a':
            strDigit = QStringLiteral("前");
            break;
...
QString MoveGenerator::chessManCodeToChinese(const QChar &code)
{
    ...
    {
    case 'k':
        strCode = QStringLiteral("将");
        break;
    case 'r':
        strCode = QStringLiteral("车");
        break;
    case 'n':
        strCode = QStringLiteral("马");
        break;
    case 'c':
        strCode = QStringLiteral("炮");
        break;
    case 'a':
        strCode = QStringLiteral("士");
        break;
    case 'b':
        strCode = QStringLiteral("象");
        break;
    case 'p':
        strCode = QStringLiteral("卒");
        break;
    case 'K':
        strCode = QStringLiteral("帅");
        break;
    case 'R':
        strCode = QStringLiteral("车");
        break;
    ...
    case 'C':
        ...
        break;
    case 'A':
        strCode = QStringLiteral("仕");
        break;
    case 'B':
        strCode = QStringLiteral("相");
        break;
    case 'P':
        strCode = QStringLiteral("兵");
        break;
    default:
        break;
    }
...
QString MoveGenerator::actionToChinese(const QChar &action)
{
    ...
    {
    case '.':
        strAction = QStringLiteral("平");
        break;
    case '+':
        strAction = QStringLiteral("进");
        break;
    case '-':
        strAction = QStringLiteral("退");
        break;
    default:
        break;
    }
